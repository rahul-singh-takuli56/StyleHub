...
import { cartLogo, logodark } from "../assets";
        ...
        <div className="flex items-center gap-8">
          ...
          <Link to="/cart">
            <div className="relative">
              <img className="w-7" src={cartLogo} alt="cartlogo" />
              <span className="absolute top-2 left-4 transform -translate-x-1/2 -translate-y-1/2 text-sm font-semibold">
                {productData.length}
              </span>
            </div>
          </Link>
